...
const ProfileEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        const response = await axios.put("/api/usuarios/editar-perfil", {
          email: email,
          givenName: givenName,
  ...
  return (
    <>
      ...
      <Typography variant="h2" color="teal" className="mt-24">
        Modificar Perfil
      </Typography>
      <div className="mb-3 w-2/3 rounded px-8 py-6 shadow">
        <div className="flex justify-between">
          ...
          <div
            ...
            htmlFor="profileimg"
          >
            <img className="mb-2 size-56 rounded-2xl" src={userImage} />
        ...
        <Button
          className="m-auto flex bg-teal-500 px-4 font-bold text-white hover:bg-teal-700"
